...
**Παρατήρηση:** Αρχικά, θεωρούμε πως είναι σημαντικό να αναφερθεί ότι στην βιβλιογραφία που διαβάσαμε είδαμε πως οι προσομοιώσεις αποκλίνουν από την πραγματικότητα σε μικρό βαθμό και άλλοτε σε μεγαλύτερο. Επιπλέον, είναι λογικό και αναμενόμενο πως εφόσον μιλάμε για προσομοιωτή θα υπάρξουν σφάλματα. Κάτι ακόμη που ενδέχεται να προκαλεί σφάλματα είναι η μοντελοποίηση του κάθε μοντέλου επεξεργαστή στο McPAT. Προσπαθήσαμε με πολλαπλές προσομοιώσεις να μειώσουμε αυτά τα σφάλματα και να βγάλουμε όσο το δυνατόν καλύτερα συμπεράσματα.
